...
namespace ChatApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangePicture(HttpPostedFileBase file)
        {
            if (file != null)
            {
                string pic = System.Web.HttpContext.Current.User.Identity.GetUserId() + System.IO.Path.GetExtension(file.FileName);
                ...
                if (!System.IO.Path.GetExtension(file.FileName).Equals(".jpg"))
                {
                    ...
                    SavePath = System.IO.Path.Combine(Server.MapPath("~/images/a"), System.Web.HttpContext.Current.User.Identity.GetUserId() + ".jpg");
                    System.IO.File.Delete(SavePath);
                    image.Save(SavePath, System.Drawing.Imaging.ImageFormat.Jpeg);
                }
                var ImgRelPath = "/images/a/" + System.Web.HttpContext.Current.User.Identity.GetUserId() + ".jpg";
                var repo = new DapperRepository();
